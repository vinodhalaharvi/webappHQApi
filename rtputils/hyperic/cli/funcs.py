...
def user_sync(data):
  if not data: 
    return ("text/html", htmlmapper('user_sync', rest('user', 'list', data, 'post')))
  return ("text/html", '<textarea name="" id="" cols="20" rows="10"><strong>%s</strong></textarea>' % rest('user', 'sync', data['xml_to_sync'], 'post'))
